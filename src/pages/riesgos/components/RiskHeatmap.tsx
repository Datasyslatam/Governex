...
const RiskHeatmap: React.FC<Props> = ({ riesgos }) => {
  ...
  return (
    <div className="risk-heatmap"> <div className="risk-heatmap__main">
        {/* Y axis */}
        <div className="risk-heatmap__y-axis"> <span className="risk-heatmap__axis-title">PROB.</span>
          {[5, 4, 3, 2, 1].map(p => (
        ...
        {/* Grid */}
        <div className="risk-heatmap__grid-wrapper"> <div className="risk-heatmap__grid">
          ...
          </div> <div className="risk-heatmap__col-labels">
            {[1, 2, 3, 4, 5].map(i => <span key={i}>{i}</span>)}
          </div> <div className="risk-heatmap__x-axis-title">IMPACTO</div> </div> </div> <div className="risk-heatmap__legend-row"> <span className="risk-heatmap__legend-item risk-heatmap__legend-item--low">Bajo (1–3)</span> <span className="risk-heatmap__legend-item risk-heatmap__legend-item--medium">Medio (4–8)</span> <span className="risk-heatmap__legend-item risk-heatmap__legend-item--high">Alto (9–14)</span> <span className="risk-heatmap__legend-item risk-heatmap__legend-item--critical">Crítico (≥15)</span> </div> </div>
  )
}
